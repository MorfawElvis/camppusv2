                ...
                <div class="table-responsive">
                    <table class="table table-bordered table2">
                        <tr>
                            ...
                            <td style="font-weight: 600;">{{ number_format($data->student->class_room->feeItems->sum('amount')
                                + $data->student->extra_fees->sum('pivot.amount')) . '  XAF'}}</td>
                        </tr>
                        @php
                            $total_paid = 0;
                        @endphp
                        ...
                        <tr>
                            <th>Balanced Owed:</th>
                            <td>{{ number_format(($data->student->class_room->feeItems->sum('amount')
                                + $data->student->extra_fees->sum('pivot.amount')) - ($total_paid + $discount) ) . '  XAF' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
